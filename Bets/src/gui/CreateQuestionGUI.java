...
public class CreateQuestionGUI extends JFrame {
	...
	public CreateQuestionGUI(Vector<domain.Event> v, Usuario user) {
		this.user= user;
	...
	//solo tiene que pintar los días con eventos de la categoría que ha sido seleccionada
	//por el usuario
	...
	private void jButtonClose_actionPerformed(ActionEvent e) {
		...
		MainAdminGUI asd = new MainAdminGUI(user);
		asd.setVisible(true);
	}
}