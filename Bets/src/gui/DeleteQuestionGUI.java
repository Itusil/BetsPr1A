...
public class DeleteQuestionGUI extends JFrame {
	...
	private JButton jButtonDelete = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DelQue"));
	...
	public DeleteQuestionGUI(Usuario user) {
		this.user=user;
	...
	private void jbInit() throws Exception {
		...
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("DelQue"));
	...
	private void jButtonDelete_action(ActionEvent e) {
		...
		int res = businessLogic.eliminarPregunta(q);
		if (res==0) {
			jLabelError.setText(ResourceBundle.getBundle("Etiquetas").getString("NoDelQue"));
			jLabelError.setVisible(true);
			jLabelError.setForeground(Color.RED);		
		}else {
			jLabelError.setText(ResourceBundle.getBundle("Etiquetas").getString("YesDelQue"));
			jLabelError.setVisible(true);
