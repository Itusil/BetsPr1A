...
public class Question implements Serializable {
	...
	public Pronostico addPronostico(String pronostico, double d, Question preguntaPronostico) {
		Pronostico p = new Pronostico(pronostico, d, preguntaPronostico);
		pronosticos.add(p);
		return p;
	}
	
	public void addPron(Pronostico p) {
		pronosticos.add(p);
	}
	
	public void removePro(Pronostico p) {
